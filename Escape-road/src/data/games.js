export const games = {
  game1: {
    ...
    aboutContent: `
            ...
            <h4>Collect Money and Gifts in Escape Road unblocked!</h4>
            ...
            <p>In Escape Road game unblocked, surprises are everywhere—police cars may appear out of nowhere, new obstacles can block your path, and the terrain may shift in an instant. Stay alert and react quickly. Staying calm under pressure is key to surviving longer.</p>
            ...
            <p>In Escape Road you canunlock 90 Unique Vehicles <br/>
                ...
                In Escape Road unblocked you can Intense Police Chases <br/>
                <a href="https://escape-road-online.com/Escape-Road">Escape Road</a> delivers high-stakes, edge-of-your-seat pursuits. Quick reflexes and sharp driving skills are essential to survive.
            </p>
            <h3>Conclusion</h3>
  ...
  game2: {
    ...
    aboutContent: `
            ...
            <h4>Escape Road 2 unblocked Revolutionary Gameplay​​</h4>
            ...
            <h3>Escape Road 2 unblocked Features</h3>
            ...
            <h3>How to Controls Escape Road 2 unblocked:</h3>
            <p>A/D: Start.<br/> Up or W keys: Accelerate.<br/> Down or S keys : Reverse.<br/>  Arrow or A/D keys: Turn.</p>
  ...
  game3: {
    ...
    aboutContent: `
            ...
            <p>
                ...
                Unblocked legendary cars—from stealth sedans to armored tanks—with rarities ranging from Common to Legendary. Each vehicle boasts unique drifting physics and speed boosts!
            </p>
            <h3>Escape Road city  unblocked Features</h3>
            ...
            <h3>How to Controls Escape Road city unblocked:</h3>
            <p>A/D: Start.<br/>Up or W keys: Accelerate.<br/>Down or S keys : Reverse.<br/>Arrow or A/D keys: Turn.</p>
  ...
  game4: {
    ...
    aboutContent: `
            ...
            <p>Escape tight situations by ditching your car and hiding in alleys or blending into traffic.<br/>
                ...
                ​Controls​​</p>
            <h3>Escape Road city 2 unblocked Features</h3>
            <p>
            ...
            <img src="/images/game04-img1.jpg" alt="Escape Road City 2 " class="game-content-image" />
            <h3>How to Controls Escape Road city 2 unblocked:</h3>
            <p>
  ...
  game5: {
    ...
    aboutContent: `
            ...
            <h3>Escape Road Winter game Features​​</h3>
            <p><strong>Unique festive atmosphere:</strong> Escape Winter Road Immerse yourself in a world full of snow, sparkling lights, and the sound of Christmas bells.<br/>
                <strong>Vivid pixel graphics:</strong> Escape Road Winter The impressive recreation of every street corner and snowflake creates an impressive visual experience.<br/>
                <strong>Diverse vehicle system:</strong> Winter Escape Road Unlock and test drive unique vehicles with different designs and performance.<br/>
                <strong>Challenging gameplay:</strong> Winter Escape Road Police pursuit becomes increasingly fierce, requiring you to handle it skillfully and decisively.</p>
  ...
  game6: {
    ...
    aboutContent: `
            ...
            <h3>Escape Road Halloween Features ​unblocked</h3>
            ...
            <h3>How to Controls Escape Road Halloween ​unblocked:</h3>
            <p>A/D: Start.<br/>
  ...
  game10: {
    ...
    aboutContent: `
            ...
            <p><strong>🥚 Shell Shockers unblocked Egg-Centric World​​:</strong> Adorable egg characters armed with over-the-top weaponry (think sniper rifles, flamethrowers, and egg-shaped grenades).<br/>
                <strong>🔫 ​Shell Shockers unblocked ​Weapon Variety​​:</strong> 15+ unique guns with distinct playstyles – from stealthy EggK-47s to chaos-inducing Scramblers.<br/>
                <strong>🎨 ​Shell Shockers unblocked ​Skin Customization​​:</strong> Unlock golden eggs, hats, and decals to personalize your egg warrior.<br/>
                <strong>🌐 ​​Shell Shockers Unblocked Play​​:</strong> Accessible on any device via Rocket Games' safe, ad-free platform.<br/>
                <strong> shell shockers Game Modes​​：</strong><br/>
            ...
            <h3>How to ​​Controls​​ Shell Shockers unblocked？</h3>
            <p>​​Move​​: W/A/S/D<br/>
            ...
            <h3>Shell Shockers unblocked Pro Tips for Victory</h3>
        ...
        <h3>🛠 Shell Shockers Hacks</h3>
            <p>​Shell Shockers hacks refer to unauthorized modifications or cheat tools that give players unfair advantages in the game, such as aimbots, wallhacks, unlimited ammo, or invincibility. These hacks are often distributed on shady websites and can pose a risk of viruses or account bans. While some players seek hacks for fun, using them violates the game's terms of service and ruins the experience for others. Always be cautious and play fair to keep the community balanced and enjoyable.<br/>
            </p>
        <h3>📜 Shell Shockers Changelog</h3>
            <p>​​The Shell Shockers changelog is an official log or update record where the developers document all changes made to the game. This includes new features, bug fixes, weapon balancing, visual improvements, seasonal events, and performance updates. By checking the changelog, players can stay up to date with the latest content, patches, and improvements, ensuring they don’t miss out on anything new or important in the game.
            </p>
        <h3>🎁 Shell Shockers Codes</h3>
            <p>​Shell Shockers codes are special promotional or redeemable codes that players can enter to unlock free rewards such as in-game items, skins, hats, or eggs. These codes are often released during events, on social media, or by the developers as giveaways. Players can enter the codes in the game’s store or settings area. It’s a fun way to collect cool items and stand out in battles.
            </p>
  ...
  game14: {
    ...
    aboutContent: `
            ...
            <h3>How to play Subway Surfers unblocked</h3>
            ...
            <h3>​Subway Surfers unblocked Core Features​​</h3>
            <h4>🚄 ​Subway Surfers ​​Endless Rail Mayhem​​:</h4>
            ...
            <h4>💨 ​​Subway Surfers ​Power-Up Arsenal​​:</h4>
            ...
            <h4>🎮 ​​Subway Surfers ​Character Customization​​:</h4>
            <p>​Subway Surfers unblocked 50+ skins (e.g., ​​Cyberpunk Jake​​, ​​Golden Surfboarder​​) and hoverboards.</p>
            ...
            <p>​​Jump​​: ↑ / W<br/>
                ...
                ​​Move Right​​: → / D<br/>
                ​​Move Left​​: ← / A</p>
            <h3>Subway Surfers unblocked Top Tips for High Scores</h3>
            <p>
             ...
             <h3>🧍‍♂️ Subway Surfers Characters</h3>
            <p>
               Subway Surfers characters are the playable avatars in the game, each with their own unique style and personality. While the default character is Jake, players can unlock others like Tricky, Fresh, Yutani, and many more from different world locations. Some characters are unlocked through coins, keys, or limited-time events. These characters often reflect different cultures and themes, adding variety and fun to the gameplay.
            </p>
             <h3>💻 Subway Surfers Unblocked GitHub</h3>
            <p>
                Subway Surfers unblocked GitHub refers to unofficial versions of the game hosted on GitHub or similar platforms that allow users to play Subway Surfers in environments where the game is normally restricted, such as schools or workplaces. These versions bypass web filters and can be accessed freely in browsers. However, they're not authorized by the developers and may pose security or performance issues, so users should proceed with caution.
            </p>
             <h3>Subway Surfers Costume</h3>
            <p>
               A Subway Surfers costume is an alternate outfit or skin for a character that changes their appearance. Many characters have multiple costumes that players can unlock by spending coins, keys, or completing missions. Costumes don’t affect gameplay but allow for personal expression and often reflect seasonal events, holidays, or regional themes. They're a fun way to customize your favorite characters and keep the game visually fresh.
            </p>
  ...
  game9: {
    ...
    aboutContent: `
            ...
            <h3>🧑‍🎤 Sprunki Incredibox Characters </h3>
            <p> Sprunki Incredibox characters refer to the unique beatbox avatars featured in the Sprunki mod of Incredibox. Each character contributes a different sound—beats, melodies, effects, voices, or choruses—and collectively creates the signature vibe of the Sprunki version. The characters have a distinct visual style, often darker, glitchier, or more futuristic compared to official versions.​</p>  
             <h3> 💻 Sprunki Incredibox Scratch</h3>
            <p>Sprunki Incredibox Scratch refers to fan-made versions or recreations of the Sprunki mod on the Scratch platform. These projects are usually interactive and allow users to simulate the Sprunki experience without accessing the official Incredibox mod. It's a popular way for fans to remix or experiment with the Sprunki theme using Scratch’s visual programming interface. ​</p> 
             <h3>🔁 Incredibox Sprunki Retake </h3>
             <p> Incredibox Sprunki Retake typically refers to an updated or revised version of the original Sprunki mod. A retake might feature improved visuals, new characters, updated sounds, or reworked phases. It’s created either by the original modder or fans aiming to refine and reimagine the original Sprunki experience.​</p> 
            <h3>🎵 Incredibox Sprunki Phase</h3>
             <h4> 🎵 Incredibox Sprunki Phase 3</h4>
              <p>Incredibox Sprunki Phase 3 is the third level or segment in the Sprunki mod, representing a more developed and intense version of the track. The visuals and audio become darker and more complex, often featuring glitch elements and heavier beats. This phase deepens the theme and pushes the atmosphere toward its edgier climax. ​</p> 
             <h4> 🎶 Incredibox Sprunki Phase 4</h4>
              <p> Incredibox Sprunki Phase 4 continues the evolution of the mod's storyline and audio buildup. It typically introduces new audio elements, character animations, and visual effects that enhance the chaotic or corrupted aesthetic. Phase 4 often serves as a transition point to the final climax in Phase 5.​</p> 
             <h4> 🌀 Incredibox Sprunki Phase 5</h4>
              <p>Incredibox Sprunki Phase 5 is usually the final and most intense part of the Sprunki mod. It includes dramatic audio effects, highly stylized visuals, and a full composition of all musical elements. The phase often delivers the emotional or thematic payoff, wrapping up the storyline in a powerful and immersive way. ​</p> 
             <h4> 🔊 Incredibox Sprunki Phase 6</h4>
              <p> Incredibox Sprunki Phase 6 marks a turning point in the Sprunki storyline, often seen as the "glitch core" or “digital corruption” climax. The music becomes heavier and more distorted, featuring complex layering of effects and chaotic beats. Visually, Phase 6 might introduce unsettling animations, glitch transitions, or fragmented imagery—symbolizing a digital world on the edge of collapse.​</p> 
             <h4>🌌 Incredibox Sprunki Phase 7 </h4>
              <p>Incredibox Sprunki Phase 7 is considered the finale or aftermath of the Sprunki saga. The tone often shifts into something more atmospheric, eerie, or reflective. Musically, it may blend soft melodies with broken effects, creating a post-glitch ambiance. This phase often represents resolution, rebirth, or the final echo of the corrupted soundscape built throughout earlier phases.​</p> 
  ...
  game8: {
    ...
    aboutContent: `
            ...
            ​<h3> ​​🚀 Planet Clicker Unblocked</h3>
            <p> Planet Clicker Unblocked allows players to enjoy the full game at school or work without restrictions. Whether you're gathering energy or upgrading your planet, this version gives you unlimited access through unblocked sites, perfect for quick, casual sessions during breaks.</p>
            ​<h3> 🧪 Planet Clicker Scratch​​</h3>
            <p> Planet Clicker Scratch is a fan-made version of the game built using MIT’s Scratch platform. It recreates the clicker gameplay with custom sprites and unique tweaks, giving players a fun and educational look at game design while clicking their way through planetary upgrades.</p>
            ​<h3> 🌍 Planet Clicker Cool Math Games​​</h3>
            <p> Planet Clicker Cool Math Games features the classic idle-clicker gameplay hosted on the popular Cool Math Games site. Known for its simple yet addictive mechanics, players collect energy to terraform and power up planets, making learning and clicking equally fun.</p>
       ​     <h3>🔓 Planet Clicker Codes​</h3>
            <p> Planet Clicker Codes are secret redeemable codes you can enter in-game to unlock bonuses such as extra energy, free upgrades, or special boosts. These codes are occasionally released by developers or hidden in game updates—so keep an eye out for them to enhance your progress!</p>
  ...
  game7: {
    ...
    aboutContent: `
            ...
            <p><strong>Learn Traffic Patterns:</strong> Memorize common routes of NPC vehicles to anticipate and evade collisions.<br/>
                ...
                <h3>🚗 In Traffic Road Game – Road Traffic Signs You Need to Know</h3>
              <h4>🚸 Cross Road Traffic Sign</h4>
             <p><strong>Appearance:</strong> A yellow diamond-shaped sign with a black "+" symbol.<br/>
                <strong>​Meaning​:</strong> This sign warns you of an upcoming intersection where vehicles may enter from either side.</p>
                <strong>In-Game Tip:</strong>Slow down when you see this sign! Crossroads are hotspots for sudden traffic — keep your reflexes sharp.</p>
                <h4>🌀 Winding Road Traffic Sign</h4>
             <p><strong>Appearance:</strong> A squiggly black arrow on a yellow background, showing curves ahead.<br/>
                <strong>​Meaning​:</strong>  You’re about to enter a winding section of road with multiple sharp turns.</p>
                <strong>In-Game Tip:</strong>Reduce your speed and keep your handling steady. Too fast, and you’ll veer off-road or crash!</p>
                <h4>🚧 Road Construction Traffic Signs</h4>
             <p><strong>Appearance:</strong> Orange signs with images like cones, workers, or tools.<br/>
                <strong>​Meaning​:</strong>  Roadwork ahead! Expect lane closures, obstacles, and unexpected detours.</p>
                <strong>In-Game Tip:</strong>Watch closely for construction zones — hitting barriers will slow you down or end your run. Sometimes, detours may lead to hidden shortcuts!</p>
  ...
  game13: {
    ...
    aboutContent: `
            ...
            <h3>​​House of Hazards unblocked Tips​​</h3>
            ...
            <h3>🎮 House of Hazards Unblocked </h3>
            <p> House of Hazards Unblocked refers to versions of the game that can be played freely online, even on networks where gaming websites might usually be restricted — like at school or work. These versions are often hosted on mirror sites or platforms that bypass standard blocks. Players can enjoy the chaotic, multiplayer fun without needing to download or install anything.</p>
            <h3> 💻 House of Hazards GitHub and 🧪 House of Hazards GitLab</h3>
            <p> House of Hazards GitHub refers to any open-source projects, fan ports, or code repositories related to the game that are hosted on GitHub.com. While the original game isn't officially open-source, fans sometimes recreate or modify versions and share assets, scripts, or mods via GitHub for educational or entertainment purposes.<br/>
  ...
  game11: {
    ...
    aboutContent: `
            ...
            <h3>Chill Guy Clicker Core Features​​</h3>
            ...
            <h3>How to Build Your Chill Empire?​i'm just a chill guy clicker​</h3>
            ...
            <p>​​Chill Guy Clicker​<br/>
             ...
             <h3>🕹️ Chill Guy Clicker Cheats​​</h3>
            <p>​Chill Guy Clicker cheats refer to tricks, hacks, or strategies players use to speed up progress, earn more coins, or unlock characters faster in the game. While there may not be official cheat codes, players often use methods like:​<br/>
                <strong>Auto-clickers: </strong> Software that automates clicks to rapidly boost points.​<br/>
                <strong>Game save editors: </strong> Tools that modify local save data to increase coins or unlock upgrades instantly.​<br/>
                <strong>Browser console hacks:</strong>In web-based versions, some players open developer tools and run custom JavaScript to manipulate in-game values.
            </p>
  ...
  game12: {
    ...
    aboutContent: `
            ...
            <h3> what is Tap Road Slope 2</h3>
            <p>​​ Tap Road is a minimalist arcade-style mobile game where players tap the screen to control a vehicle's direction. It combines reflexes, timing, and strategy, especially as the roads twist, traffic increases, and speed ramps up. Easy to play, but hard to master.</p>
           <h3> what is Road Tape</h3>
            <p>​​ Road tape is commonly used in driving games or simulations to represent temporary markings or guidance on the road. In game environments, it may appear as caution zones, lane guides, or level design elements that direct player movement. In real life, it’s used for construction, detours, or training.</p>
           <h3> what is Plank Road Tap Room</h3>
            <p>​​ Plank Road Tap Room is a popular real-world location known for its craft beer selection and community vibe. Often referenced in travel or food games, it’s a chill setting where players may simulate managing a bar, exploring menus, or hosting events. Great for casual  Tap Road game atmospheres or social simulation.</p>
           <h3> what is The Brass Tap – Cross Roads</h3>
            <p>​​ The Brass Tap - Cross Roads is a branch of the Brass Tap franchise, combining a pub-style setting with live music, trivia nights, and a large drink menu. In game design, this kind of setting can serve as a hangout zone, side quest hub, or even a reward room after a driving or delivery challenge.</p>
...
<p>Free <a href="https://escape-road-online.com/Drift-Boss">Drift Boss unblocked</a> Games Play Online</p>
 ...
 <p>Free <a href="https://escape-road-online.com/Crazy-Sheep-3D">Crazy Sheep 3D</a> Game Play Online</p>
  ...
  game69: {
    id: 'lizard-lizard-clicker',
    title: 'Lizard Lizard Clicker - Cute Idle Clicker Fun',
    description:
      'Lizard Lizard Clicker is a fun and quirky idle clicker game where you meet adorable lizards, click to earn points, and buy upgrades to unlock more lizards and boost your progress!',
    keywords:
      'lizard lizard clicker, idle clicker, clicker game, casual game, lizard game, upgrade clicker, idle fun, incremental game',
    addressBar: 'Lizard-Lizard-Clicker',
    logoText: 'Lizard Lizard Clicker',
    image: 'game-69.webp',
    ...
    aboutContent: `
      ...
      <p><strong>Lizard Lizard Clicker</strong> is the latest addition to the Clicker Games collection, where players get to meet cute and quirky lizards by simply clicking and upgrading. Each click brings you closer to unlocking a new lizard companion, making it a relaxing and fun experience for casual gamers.</p>
  
      <img src="/images/game69-img1.webp" alt="Lizard Lizard Clicker">
  
      <h2>Lizard Lizard Clicker Gameplay Walkthrough</h2>
      <p><strong>Lizard Lizard Clicker</strong> is a thrilling idle clicker game developed by Azgames.io. The gameplay is simple yet addictive—click the lizard to earn points, buy upgrades, and watch your progress skyrocket. Unlike many other idle games, this one is centered around a cast of unique lizards that appear as you hit milestones. Relax, collect, and enjoy the quirky charm!</p>
  
      <h2>Ready to Dive In? Here's How to Play</h2>
      <ul>
        <li><strong>Click to Start:</strong> Begin with nothing and click the lizard repeatedly to earn your first points. Each click gives you 1 point, and fast clicking can even earn you 2 points per click.</li>
        <li><strong>Buy Upgrades:</strong> Use your earnings to purchase upgrades. These upgrades improve your click power and unlock idle income, allowing points to accumulate automatically.</li>
        <li><strong>Unlock Lizards:</strong> As you progress, meet new and adorable lizards. Each one adds charm and keeps you motivated to keep clicking.</li>
        <li><strong>Scale Up:</strong> The more upgrades you invest in, the faster your progress. Unlock stronger upgrades, boost your score, and continue the rewarding loop of clicking and upgrading.</li>
      </ul>
  
      <h2>Gameplay Objectives</h2>
      <p>The main goal of <strong>Lizard Lizard Clicker</strong> is simple: unlock as many lizards as possible while scaling up your earnings. There are no strict levels or competition—just relaxed, incremental progress and the joy of discovering more lizards with each milestone.</p>
  
      <h2>Tips for Success</h2>
      <p>
        <strong>Click First:</strong> Focus on clicking early to earn your starter points.<br>
        <strong>Upgrade Wisely:</strong> Buy the most impactful upgrades early to boost both clicks and idle income.<br>
        <strong>Keep Unlocking:</strong> Stay motivated by unlocking new lizards, which keeps the game fresh and fun.<br>
        <strong>Relax & Enjoy:</strong> Remember, the game is about laid-back fun. No rush, no stress—just clicks and lizards!<br>
      </p>
  
      <p>With its mix of incremental progress and quirky lizard characters, <strong>Lizard Lizard Clicker</strong> offers a funny, relaxing, and endlessly replayable clicker experience. Click, upgrade, unlock, and enjoy your journey with these charming lizards!</p>
    `,
  },

  game70: {
    id: 'hoop-legends',
    title: 'Hoop Legends - Realistic 3D Basketball Game',
    description:
      'Hoop Legends is a realistic 3D basketball game with immersive visuals, smooth gameplay, and exciting customization options. Play now and shoot your way to victory!',
    keywords:
      'hoop legends, basketball game, 3D basketball, sports game, hoop shooting, basketball simulator, casual sports game, basketball challenge',
    addressBar: 'Hoop-Legends',
    logoText: 'Hoop Legends',
    image: 'game-70.webp',
    ...
    aboutContent: `
      ...
      <p><strong>Hoop Legends</strong> is a realistic 3D basketball game packed with different modes and customization options. Unlike many other sports games, it emphasizes lifelike basketball visuals and immersive gameplay, giving you a truly engaging hoops experience. Play it now on AZgames.io and enjoy the thrill of shooting baskets!</p>
  
      <img src="/images/game70-img1.webp" alt="Hoop Legends">
  
      <h2>More About Hoop Legends</h2>
      <p><strong>Hoop Legends</strong> is perfect for anyone who loves basketball. The gameplay is focused on hooping and scoring, keeping things fast and exciting without unnecessary complexity. With its strong customization features, different play modes, and realistic animations, this game brings the excitement of the court straight to your fingertips.</p>
  
      <h2>Gameplay Highlights</h2>
      <ul>
        <li><strong>Immersive Graphics:</strong> Realistic 3D visuals with smooth animations make every shot feel authentic and satisfying.</li>
        <li><strong>Multiple Game Modes:</strong> Play single-player challenges, timed shooting matches, and more exciting modes.</li>
        <li><strong>Customization:</strong> Unlock basketball skins, uniforms, and unique courts to personalize your experience.</li>
        <li><strong>Easy Controls:</strong> Intuitive drag-and-release mechanics make shooting hoops simple and fun.</li>
      </ul>
  
      <h2>Shoot the Hoop & Become a Court Legend</h2>
      <p>Choose your favorite mode and jump into the action. In time-based challenges, score as many baskets as possible within the limit. In competitive modes, outscore your opponent to claim victory. Each successful basket increases your score, bringing you closer to becoming a true hoop legend.</p>
  
      <p>With the MP you earn, unlock new basketballs, courts, and uniforms. These upgrades not only enhance the visuals but may also provide small performance boosts, keeping the game fresh and rewarding as you progress.</p>
  
      <h2>How to Play</h2>
      <ul>
        <li><strong>Aim Your Shot:</strong> Drag to set your angle and power.</li>
        <li><strong>Release to Shoot:</strong> Let go to throw the ball toward the hoop.</li>
        <li><strong>Score Points:</strong> Only baskets that go in count toward your score.</li>
      </ul>
  
      <h2>Game Controls</h2>
      <p>Use the <strong>left mouse button</strong> to swipe and throw the basketball toward the hoop.</p>
